...
class UsuarioService (
    ...
    fun atualizar(id:Long, usuario: Usuario) : Usuario? {
        var usuariosExistente = repository.findById(id).orElse(null)?: return null
        usuariosExistente.email = usuario.email
        usuariosExistente.senha = usuario.senha
        return repository.save(usuariosExistente)
